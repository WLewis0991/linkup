      ...
      <div className="max-w-xl mx-auto flex flex-col gap-6">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: isDark ? "0 8px 40px rgba(0,0,0,0.35)" : "0 8px 40px rgba(15,23,42,0.08)",
          }}
        >
          ...
          <p className="text-sm dark:text-slate-500 text-slate-400 italic max-w-xs">No bio yet.</p>
        </div>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <button onClick={closeDialog} className="dark:text-slate-400 text-slate-500 hover:text-slate-700 dark:hover:text-slate-200">
